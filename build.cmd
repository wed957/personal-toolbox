...
if errorlevel 1 exit /b 1
"%GXX%" -std=c++17 -O2 -Wall -Wextra -Wpedantic -Wno-cast-function-type -municode -mwindows -DUNICODE -D_UNICODE -DWIN32_LEAN_AND_MEAN -DNOMINMAX "%~dp0src\gui.cpp" "%~dp0build\app-resources.o" -o "%~dp0build\icc-switch-gui.exe" -luser32 -lgdi32 -lcomdlg32 -static-libgcc -static-libstdc++
exit /b %errorlevel%
